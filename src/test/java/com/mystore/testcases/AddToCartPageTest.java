...
public class AddToCartPageTest extends BaseClass {
	...
	public void addToCartTest(String productName, String qty, String size) throws Throwable {
		...
		addToCartPage.closepopupbutton();
		
		boolean result=addToCartPage.validateAddtoCart();
		Assert.assertTrue(result);
		Log.endTestCase("addToCartTest");
		// assert true is not working because the issue is on the webpage and it is not redirecting to other page  report it to the developer for the bug 
	}
}
