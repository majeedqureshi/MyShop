...
public class HomePageTest extends BaseClass {
	...
	public void MyCreditSlip(String uname, String pswd) throws Throwable {
		Log.startTestCase("MyCreditSlip");
		indexPage= new IndexPage();
		loginPage=indexPage.clickOnSignIn();
		homePage=loginPage.login(uname,pswd,homePage);
		boolean result=homePage.validateMyCreditSlip();
		Assert.assertTrue(result);
		Log.endTestCase("MyCreditSlip");
	}
